...
- [x] __게시판에서의 선택박스(소형견에게 or 중형견에게 추천넣기)__ 추천 태그로 변경 </br> 
        └> 추천태그로 변경 </br>
- [ ] __게시판의 정보를 저장할때 DB에 이미지정보를 우리가 직접 포함시켜줘서 파일업로드마냥 DB에 저장을 시켜준다 그러면 편하게 값을 가져올수있다.__ </br>
        └> 엑셀을 활용한 데이터 수집  
- [ ] __카테고리 버튼의 수정__ 
--------
### ＊ __HOME  수정사항 </br>
...
----------------
### ＊ __시판 수정사항__ </br> 
- [ ] __카테고리별 버튼의 색상 변경__ </br>
        -> 메뉴바랑 색상이 겹침
- [ ] __찜목록 선택시 문구 변경__</br> 
        -> 오타
- [ ] __조회수 제한 주기__ </br>
        -> 무한으로올라가는현상, 조회수 위치변경
- [ ] __후기작성 및 별점__ </br>
...
- [ ] __게시글 버튼, 댓글버튼의 색상 변경__ </br>
        -> 색상 불일치
- [ ] __댓글 더보기__ </br>
        -> 댓글이 없는 상태에서 클릭되버림 수정필요 
--------
### ＊ __HOME 메인화면 수정사항 </br>
- [ ] __배너 TOP1 문구 변경__ </br>
        -> 오타
- [ ] __최근 본 게시글 추가__ </br>
        -> 4개 -> 8개 까지 볼수있게 변경
- [ ] __랜덤 게시글 추가__  </br>
        -> 랜덤으로 게시글 가져와 1주일 쿠키생성
- [ ] __카테고리별 별점 및 조회수 높은 게시글 추가__ </br>
...
- [ ] __카테고리별 마커 추가__  </br>
        -> 각 카테고리별로 마커가 나오게 변경 
- [ ] __지도 위에 이미지나 디자인 크기 변경__ </br>
        -> 지도와 크기를 비슷하게 
--------- 
### ＊__로그인/회원가입 수정사항__ </br>
- [ ] __아이디 중복시 체크박스 색상 변경__  </br>
        -> 중복시 색상이 변경되게끔
- [ ] __휴대폰번호 입력 글자수 제한__ </br>
        -> 8자리가 아닐시 사용자에게 확인시키기
- [ ] __이메일 선택박스 추가__  </br>
        -> 직접 입력칸 추가
- [ ] __비밀번호 찾기 입력창 오류__  </br>
        -> 오류문구 추가
- [ ] __아이디/비밀번호 찾기 페이지 추가__  </br>
        -> 로그인시 밑에 버튼으로 추가
- [ ] __회원정보 수정시 오류__  </br>
        -> 잘못된 정보 입력시 오류문구 추가
- [ ] __찜목록, 사용자가 작성한 게시글 추가__  </br>
        -> 페이지 추가 필요 

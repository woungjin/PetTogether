...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
   ...
   <img src="${pageContext.request.contextPath }/resources/img/starboard/${lank.bno }.jpg" alt="">
    ...
    <div class=".sec_where">
        ...
        <section class="MainHeader-module__container--LCI8z">
            <div class="Grid-module__container--1Vs_H">
                                ...
                                <div class="MainCityVideo-module__container--3bdht swiper-slide swiper-slide-active" style="width: 270px;">
                                    ...
                                    <div class="MainCityVideo-module__header--_YDeH">
                                        ...
                                        <span class="MainCityVideo-module__desc--3kOvx">
                                            <span style="overflow: hidden; text-overflow: ellipsis; -webkit-box-orient: vertical; display: -webkit-box; -webkit-line-clamp: 2;"><!-- 2 여행 상품 --></span>
                                        </span>
                                    </div>
                                </a>
                                </div>
                ...
                <!-- ====================================================================================== -->      
                        ...
                        <!-- ====================================================================================== -->      
    	              <c:forEach var="hello" items="${allList2}" begin="0" end="31" varStatus="status">
    	              		<c:if test="${status.index % 8 == 0 }">
    	<!-- 이번주 랜덤 게시판 1111111111111111111111111 -->
                    ...
                    <div class="Grid-module__container--1Vs_H">
                        <div class="Grid-module__row--338xw">
                            <header class="SectionHeader-module__container--2hO_V">
                                ...
                                <div>
                                    <h2 class="SectionHeader-module__title--2JM-O">${hello.category }</h2>
                                </div>
		...
		<div class="mySlides${status.index} fade">
		                         <c:forEach var="vo" items="${allList2}" begin="${status.index+4 }" end="${status.index+7 }">
		...
		<span class="swiper-pagination-bullet dot${status.index}"  onclick="currentSlide${status.index}(1)" tabindex="0" role="button" aria-label="Go to slide 1"></span>
		<span class="swiper-pagination-bullet dot${status.index}"  onclick="currentSlide${status.index}(2)" tabindex="0" role="button" aria-label="Go to slide 1"></span>
		</div>
		                    </c:if>
		                </c:forEach> 
                    ...
                    <div class="Grid-module__container--1Vs_H">
                        <div class="Grid-module__row--338xw">
                            <header class="SectionHeader-module__container--2hO_V">
                                ...
                                <div>
                                    <h2 class="SectionHeader-module__title--2JM-O">이번주 랜덤 게시판2</h2>
                                </div>
		...
		<div style="text-align:center">
		  ...
		  <span class="dot2" onclick="currentSlide2(2)"></span> 
					...
					<c:if test="${cookieBoard[0] != null }">
                                <div>
                                    <h2 class="SectionHeader-module__title--2JM-O">최근 본 게시글1</h2>
                                </div>
                  </c:if>
                            </header>
                        </div>
		...
		<div class="mySlides fade">
	              ...
	              <c:forEach var="vo" items="${cookieBoard}" begin="0" end="3">
		  <div class="numbertext"> 1</div>
		...
		<div class="mySlides fade">
		               		              <c:forEach var="vo" items="${cookieBoard}" begin="4" end="7">
		  <div class="numbertext">2 </div>
                                        <a href="${pageContext.request.contextPath }/starBoard/freeDetail?bno=${vo.bno}" class="CardContainer-module__container--15PwL CardShare-module__container--3ENNV CardContainer-module__offer--MXYO5 CardContainer-module__swiper--2aP0C swiper-slide swiper-slide-next" style="width: 270px;">
                                            <div class="OfferVerticalCard-module__thumbnail--WrSzy">
                                                <div class="CardThumbnail-module__container--1YPw8 CardThumbnail-module__vertical--3Jyvq">
		  ...
		  <div class="text"><!-- Caption Tw o --></div>
		</div>
	...
	<script>
     ...
     // 0 호텔 
     	...
     	function showSlides0(n0) {
     	  ...
     	  if (n0 > slides0.length) {slideIndex0 = 1}    
     	  if (n0 < 1) {slideIndex0 = slides0.length}
...
function showSlides16(n16) {
  ...
  if (n16 > slides16.length) {slideIndex16 = 1}    
  if (n16 < 1) {slideIndex16 = slides16.length}
  for (i16 = 0; i16 < slides16.length; i16++) {
      slides16[i16].style.display = "none";  
  }
  for (i16 = 0; i16 < dots16.length; i16++) {
      dots16[i16].className = dots16[i16].className.replace(" active", "");
  }
...
if (n24 > slides24.length) {slideIndex24 = 1}    
if (n24 < 1) {slideIndex24 = slides24.length}
for (i24 = 0; i24 < slides24.length; i24++) {
   slides24[i24].style.display = "none";  
}
for (i24 = 0; i24 < dots24.length; i24++) {
   dots24[i24].className = dots24[i24].className.replace(" active", "");
}

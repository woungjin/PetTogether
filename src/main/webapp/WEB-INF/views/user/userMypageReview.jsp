<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <main class="traveler">
        ...
        <div class="profile">
        <img alt="여행자 사진" class="img-circle" src="https://d2ur7st6jjikze.cloudfront.net/profile_images/3524305/3524305_medium_1610952381.png?1610952381" width="80">
        </div>
        <div class="username">
        이진웅
        </div>
    ...
    <div class="text"><span>친구 초대하고</span><span class="accent">&nbsp;2,000포인트&nbsp;</span><span>받기!</span></div> -->
        ...
        <!-- <div class="innerbox">
        <div class="item text-lg">사용가능한 포인트</div>
        <div class="item text-xlg font-bold">0원</div>
        </div> -->
        ...
        <div class="text">• 적립된 포인트는 상품 구매 시 현금처럼 사용할 수 있습니다.<br>• 단, 마이리얼트립 내 항공권 구매 또는 호텔 예약 시에는 사용하실 수 없습니다.<br>• 포인트는 발급 형태에 따라 유효기간이 다르며, 유효기간이 만료된 캐시는 만료일 자정에 자동 소멸됩니다.<br>• 지급 받으신 포인트는 본인만 사용가능하며 타인에게 양도할 수 없습니다.<br></div>
        </div>
